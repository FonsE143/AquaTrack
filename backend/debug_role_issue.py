...
def test_role_issue():
    print("Testing role issue in ProfileSerializer...")
    
    # Clean up any existing test users
    try:
        User.objects.filter(username__in=['test_staff_role']).delete()
    ...
    test_data = {
        'username': 'test_staff_role',
        'first_name': 'Test',
        'last_name': 'Staff',
        'email': 'test.staff@test.com',
        'phone': '09123456789',
        'role': 'staff'  # This should be passed to serializer
    }
