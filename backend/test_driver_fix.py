...
def test_driver_fix():
    print("Testing driver fix with context...")
    
    # Clean up any existing test users
    try:
        User.objects.filter(username__in=['test_driver_context']).delete()
    ...
    serializer = ProfileSerializer(data=test_data, context={'role': 'driver'})
    ...
    try:
        ...
        print(f"Successfully created driver profile: {profile}")
