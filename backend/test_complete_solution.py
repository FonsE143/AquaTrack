...
def test_complete_solution():
    ...
    try:
        User.objects.filter(username__in=['test_staff_api', 'test_driver_api']).delete()
    ...
    # Clean up
    try:
        User.objects.filter(username__in=['test_staff_api', 'test_driver_api', 'testadmin_complete']).delete()
